 ...
 *
 * Created by PhpStorm.
 * User: Torans <https://github.com/torans>
 * Date: 19/9/12
 * Time: 02:10
 */
...
return [
    ...
    */
    'oauth' => [
         ...
         */
        'app-01' => [
            'client_id' => env('DING_CLIENT_ID_1'),
            'client_secret' => env('DING_CLIENT_SECRET_1'),
            'scope' => env('DING_SCOPE_1'),
            'redirect' => env('APP_URL').'/home',
        ],
        /*
        |-------------------------------------------
